...
const AiAssistant: React.FC = () => {
  return (
    <div className="bg-black bg-[url('/images/green-layyerd-bg.webp')] bg-cover md:bg-center bg-right overflow-hidden">
      <div className="relative container mx-auto py-20 md:py-32 flex flex-col items-center text-center">
        {/* --- Text Content --- */}
        ...
        <div className="flex md:flex-row flex-col-reverse relative z-10 mt-16 w-full md:items-start items-center justify-center">
          ...
          ></div>
          {/* Left Card */}
          <div className="relative transform -translate-x-1 top-6 lg:min-w-[250px] min-w-[200px] min-h-[300px] -rotate-12">
            <Image
              src={leftcardAiUrl}
              alt="Crypto Card"
          ...
          {/* Center Image */}
          <div className="relative lg:block hidden xl:min-w-[664px] min-w-[530px] min-h-[495px]">
            <Image
              src={desktopImageUrl}
          ...
          {/* Right Card */}
          <div className="relative md:block hidden transform top-6 md:translate-x-1 lg:min-w-[250px] min-w-[200px] min-h-[300px] rotate-12">
            <Image
              src={rightCardAiUrl}
              alt="Crypto Card"
              className="object-contain"
